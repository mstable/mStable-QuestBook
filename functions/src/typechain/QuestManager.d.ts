...
interface QuestManagerInterface extends ethers.utils.Interface {
  functions: {
    ...
    'completeQuestUsers(uint256,address[],bytes)': FunctionFragment
    'completeUserQuests(address,uint256[],bytes)': FunctionFragment
  ...
  encodeFunctionData(functionFragment: 'completeQuestUsers', values: [BigNumberish, string[], BytesLike]): string
  encodeFunctionData(functionFragment: 'completeUserQuests', values: [string, BigNumberish[], BytesLike]): string
  ...
  decodeFunctionResult(functionFragment: 'completeQuestUsers', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'completeUserQuests', data: BytesLike): Result
  ...
  events: {
    ...
    'QuestCompleteQuests(address,uint256[])': EventFragment
    'QuestCompleteUsers(uint256,address[])': EventFragment
  ...
  getEvent(nameOrSignatureOrTopic: 'QuestCompleteQuests'): EventFragment
  getEvent(nameOrSignatureOrTopic: 'QuestCompleteUsers'): EventFragment
...
export class QuestManager extends BaseContract {
  ...
  callStatic: {
    ...
    completeQuestUsers(_questId: BigNumberish, _accounts: string[], _signature: BytesLike, overrides?: CallOverrides): Promise<void>

    completeUserQuests(_account: string, _ids: BigNumberish[], _signature: BytesLike, overrides?: CallOverrides): Promise<void>
  ...
  filters: {
    ...
    QuestCompleteQuests(user?: string | null, ids?: null): TypedEventFilter<[string, BigNumber[]], { user: string; ids: BigNumber[] }>

    QuestCompleteUsers(
      questId?: BigNumberish | null,
      accounts?: null,
    ): TypedEventFilter<[BigNumber, string[]], { questId: BigNumber; accounts: string[] }>
