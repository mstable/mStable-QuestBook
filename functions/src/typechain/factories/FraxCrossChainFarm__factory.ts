...
import type {
  FraxCrossChainFarm,
  FraxCrossChainFarmInterface,
} from "../FraxCrossChainFarm";
    ...
    outputs: [
      {
        ...
        internalType: "struct FraxCrossChainFarm.LockedStake[]",
        name: "",
        type: "tuple[]",
      },
    ],
...
export class FraxCrossChainFarm__factory {
  static readonly abi = _abi;
  static createInterface(): FraxCrossChainFarmInterface {
    return new utils.Interface(_abi) as FraxCrossChainFarmInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): FraxCrossChainFarm {
    return new Contract(address, _abi, signerOrProvider) as FraxCrossChainFarm;
  }
}
