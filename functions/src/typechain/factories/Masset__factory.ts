...
import type { Masset, MassetInterface } from "../Masset";
...
export class Masset__factory {
  static readonly abi = _abi;
  static createInterface(): MassetInterface {
    return new utils.Interface(_abi) as MassetInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Masset {
    return new Contract(address, _abi, signerOrProvider) as Masset;
  }
}
