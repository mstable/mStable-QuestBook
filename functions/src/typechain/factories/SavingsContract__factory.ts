...
export class SavingsContract__factory {
  static readonly abi = _abi;
  static createInterface(): SavingsContractInterface {
    return new utils.Interface(_abi) as SavingsContractInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SavingsContract {
    return new Contract(address, _abi, signerOrProvider) as SavingsContract;
  }
}
